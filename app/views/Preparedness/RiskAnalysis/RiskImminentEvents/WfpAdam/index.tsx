...
import RiskImminentEventMap, { type EventPointFeature } from '../../RiskImminentEventMap';
import {
    type RiskLayerProperties,
    type RiskLayerSeverity,
} from '../../RiskImminentEventMap/utils';
...
function WfpAdam(props: Props) {
    ...
    const pointFeatureSelector = useCallback(
        (event: EventItem): EventPointFeature | undefined => {
            ...
            const details = event_details as { latitude?: number; longitude?: number } | undefined;
