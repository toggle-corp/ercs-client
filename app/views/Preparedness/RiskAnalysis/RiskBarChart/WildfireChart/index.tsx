                    ...
                    description={(
                        <>
                            <TextOutput
                                ...
                                strongValue
                                label={resolveToString('Min-max (2003 - {currentYear})', { currentYear })}
                            />
                            <TextOutput
                                value={monthData.average}
                                label={resolveToString('Average (2003 - {currentYear})', { currentYear })}
                                valueType="number"
                                strongValue
                            />
                            <TextOutput
                                value={monthData.current}
                                label={resolveToString('Year {currentYear}', { currentYear })}
                                valueType="number"
                                strongValue
                            />
                        </>
    ...
    return (
        ...
        >
            ...
            <ChartAxes
                ...
                onHover={handleHover}
                yAxisLabel="Monthly Severity Rating"
            />
        </ChartContainer>
    );
}
